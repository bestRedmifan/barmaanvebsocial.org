...
<div class="grid">
  ...
  <button
    type="button"
    onclick="selectSubject('Short')">
    Short
  </button>

  <button
    type="button"
    onclick="selectSubject('News Short')">
    News Short
  </button>

  <button
    type="button"
    onclick="selectSubject('Photo')">
    Photo
  </button>

  <button
    type="button"
    onclick="selectSubject('Poll')">
    Poll
  </button>

  <button
    type="button"
    onclick="selectSubject('Text')">
    Text
  </button>

  <button
    type="button"
    onclick="openPublicError()">
    Public
  </button>
...
function renderForm(selectedType) {
...
form.innerHTML =
  '<div class="notice">' +
  "No empty slot for this subject. " +
  "Try tomorrow in GMT+3:30." +
  "</div>";
...
<label>
  ${captionNumber}. Write the caption
</label>
