...
// File content is supported by posts.json.
// File content can use a password code.
// File download starts from the repository file.
// File password is checked before download.
// End of blocked support.
// ===============================
// File support notes
// ===============================
// type file uses post.file as its source.
// post.file should point to a repository file.
// The Download button is shown for file posts.
// Password protected files keep the button visible.
// Clicking a protected file asks for its code.
// Correct code starts the browser download.
// Wrong code keeps the file from downloading.
// Files do not change existing post types.
// Existing JSON structure remains supported.
// Existing captions remain supported.
